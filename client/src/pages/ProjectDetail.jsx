        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
            ...
            <div className="container mx-auto px-6 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {/* Done Column */}
                    <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl shadow-lg">
                        <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-5 py-4 rounded-t-xl">
                            <div className="flex items-center justify-between text-white">
                                <h3 className="text-lg font-bold flex items-center">
                                    <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="bg-white text-green-700 text-sm font-bold px-3 py-1 rounded-full">
                                    {statusColumns['Done'].length}
                                </span>
                            </div>
                        </div>
                        <div className="p-4 space-y-3 min-h-[400px]">
